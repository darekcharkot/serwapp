...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference("Hardware.count") do
      post hardwares_url, params: { hardware: { description: @hardware.description, model: @hardware.model, type: @hardware.type } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { description: @hardware.description, model: @hardware.model, type: @hardware.type } }
